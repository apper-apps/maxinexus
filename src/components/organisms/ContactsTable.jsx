...
const sortedContacts = [...contacts].sort((a, b) => {
    let aValue = a[sortField === "name" ? "Name" : sortField]
    let bValue = b[sortField === "name" ? "Name" : sortField]
            ...
            <tbody className="bg-white divide-y divide-gray-100">
                {sortedContacts.map(contact => <tr
                    ...
                    className={cn(
                        ...
                        selectedContact?.Id === contact.Id ? "bg-gradient-to-r from-primary/10 to-secondary/10 border-l-4 border-primary" : ""
                    )}>
                    <td
                        ...
                        <div className="flex items-center">
                            <div
                                className="h-8 w-8 bg-gradient-to-br from-primary to-secondary rounded-full flex items-center justify-center mr-3">
